...
public class Grid extends BaseGridComponent {
    ...
    public void updateUI() {
        GridUIProcessor processor = ExtraDesignClassManager.getInstance().getGridUIProcessor();
        ComponentUI ui = processor == null ? new GridUI(resolution) : processor.appearanceForGrid(resolution);
        this.setUI(ui);
    }
